...
public:
    ...
    void generate() {
        ...
        Func gPyramid[maxJ];
        for (int i = 0; i < maxJ; ++i) gPyramid[i] = Func("gPyramid_" + std::to_string(i));
        ...
        Func lPyramid[maxJ];
        for (int i = 0; i < maxJ; ++i) lPyramid[i] = Func("lPyramid_" + std::to_string(i));
        ...
        for (int i = 0; i < maxJ; ++i) inGPyramid[i] = Func("inGPyramid_" + std::to_string(i));
        ...
        for (int i = 0; i < maxJ; ++i) outLPyramid[i] = Func("outLPyramid_" + std::to_string(i));
        for (int j = 0; j < J; j++) {
        ...
        for (int i = 0; i < maxJ; ++i) outGPyramid[i] = Func("outGPyramid_" + std::to_string(i));
